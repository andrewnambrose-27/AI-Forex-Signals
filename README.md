...
- ATR-normalised support/resistance zones with break-and-retest detection
...
- `GET /api/analysis/zones?symbol=EURUSD&timeframe=5m` returns the strongest ATR-clustered support/resistance zones, including touch strength, higher-timeframe confluence, buffered breaks, and retests.
